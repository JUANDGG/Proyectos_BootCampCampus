//imports
import { structValidate, validateField } from "./validations.js"
import { uri } from "../util/config.js"
...
const deleteOne = async (endPoint, id) => {
    ...
    if (validateEndP === true && typeof id === "number") {
        ...
        let request = await (await fetch(uri + endPoint + "/" + id, config))
    }
}

const putOne = async (endPoint, id) => {
    config.method = 'PATCH'
